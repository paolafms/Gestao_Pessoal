document.getElementById('form-financeiro').addEventListener('submit', function(event) {
    ...
    const newRecord = { descricao, data, valor, tipo };
    ...
    window.location.href = 'index.html'; // Redireciona de volta para a página de listagem
});
...
document.addEventListener('DOMContentLoaded', carregarRegistroParaEditar);
